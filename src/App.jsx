...
function App() {
  ...
  const skinInfo = result?.type === 'skin' ? SKIN_MAP[result.prediction] || { emoji: '🔬', color: '#94a3b8', desc: result.prediction } : null
    ...
    <div className="app-container">
      ...
      <header>
        ...
        <div className="header-stats">
          <div className="stat-pill">🧠 6 Modèles</div>
          <div className="stat-pill">📊 3 Objectifs</div>
          <div className="stat-pill">💄 Skincare IA</div>
        </div>
      </header>
      ...
      <main>
        ...
        {activeTab === 'skin' && (
          <div className="model-container">
            <div className="model-header">
              ...
              <p>Random Forest · XGBoost · Neural Network</p>
            ...
            <form onSubmit={(e) => handlePredict(e, 'skin', skinForm)}>
              ...
              <button type="submit" className="submit-btn" disabled={loading}>
                {loading ? <span><div className="loader"></div> Analyse en cours…</span> : '🔍 Analyser le Type de Peau'}
              </button>
            </form>
            ...
            {result?.type === 'skin' && skinInfo && (
              <div className="result-card" style={{ borderColor: `${skinInfo.color}40`, background: `${skinInfo.color}0a` }}>
                <div className="result-label">Résultat de l'analyse</div>
                <div className="result-emoji">{skinInfo.emoji}</div>
        ...
        {activeTab === 'patient' && (
          <div className="model-container">
            <div className="model-header">
              ...
              <p>K-Means Clustering · DBSCAN Density</p>
              <div className="model-chips">
            ...
            <div className="cluster-info-section">
              <div className="cluster-info-header">
                ...
                <div>
                  <h3>Comment les clusters ont-ils été créés ?</h3>
                  <p>L'algorithme K-Means analyse les données de <strong>55 000+ patients</strong> du dataset <code>healthcare_dataset.csv</code> sur 3 variables : l'<strong>Âge</strong>, le <strong>Genre</strong> et le <strong>Groupe Sanguin</strong>. Il regroupe automatiquement les patients en <strong>3 segments distincts</strong> selon leur similarité statistique.</p>
                </div>
              </div>
              ...
              <div className="clusters-grid">
                <div className="cluster-card cluster-0">
                  ...
                  <div className="cluster-emoji">👩‍⚕️</div>
                ...
                <div className="cluster-card cluster-1">
                  ...
                  <div className="cluster-emoji">👨‍💼</div>
            ...
            <form onSubmit={(e) => handlePredict(e, 'patient', patientForm)}>
              ...
              <button type="submit" className="submit-btn" disabled={loading}>
                {loading ? <span><div className="loader"></div> Segmentation…</span> : '🧩 Segmenter le Patient'}
              </button>
            </form>
            ...
            {result?.type === 'patient' && result.cluster !== undefined && (
              <div className="result-card" style={{
                borderColor: `${CLUSTER_COLOR[result.cluster] || '#818cf8'}50`,
                background: `${CLUSTER_COLOR[result.cluster] || '#818cf8'}0a`
              }}>
                <div className="result-label">{result.cluster === 'Anomalie (Bruit DBSCAN)' ? '⚠️ Profil Atypique' : '✅ Segment identifié'}</div>
                <div className="result-emoji">{result.cluster === 'Anomalie (Bruit DBSCAN)' ? '🚨' : '🎯'}</div>
                <div className="result-value" style={{ color: CLUSTER_COLOR[result.cluster] || '#818cf8' }}>
        ...
        {activeTab === 'product' && (
          <div className="model-container">
            <div className="model-header">
              <div className="model-icon-wrap">🛍️</div>
              <h2>Recommandation Skincare</h2>
              <p>Neural Network · K-Nearest Neighbors</p>
              <div className="model-chips">
                <span className="chip chip-ann">ANN</span>
            ...
            <form onSubmit={(e) => handlePredict(e, 'product', productForm)}>
              ...
              <button type="submit" className="submit-btn" disabled={loading}>
                {loading ? <span><div className="loader"></div> Recherche des meilleurs produits…</span> : '✨ Trouver les Meilleurs Produits'}
              </button>
            </form>
            ...
            {result?.type === 'product' && (
              <div className="result-card product-result-card">
                <div className="result-label">Recommandations IA</div>
